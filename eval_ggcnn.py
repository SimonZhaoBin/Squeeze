...
#from models.squeezenet import 'squeezelll'
#import SQUEEZENET as squeezelll
...
def parse_args():
    parser = argparse.ArgumentParser(description='Evaluate squeeze')

    # Network
    parser.add_argument('--network', type=str, default='squeeze_weights_cornell/epoch_44_iou_0.81_statedict.pt', help='Path to saved network to evaluate')
